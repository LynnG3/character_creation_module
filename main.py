...
"""Импортирует генератор случайных чисел."""


from graphic_arts.start_game_banner import run_screensaver

def attack(char_name: str, char_class: str) -> str:
    """Генерирует значение атаки в зависимости от класса."""
    if char_class == 'warrior':
        return (f'{char_name} нанёс противнику {5 + randint(3, 5)}ед.урона')
    if char_class == 'mage':
        return (f'{char_name} нанёс противнику {5 + randint(5, 10)}ед.урона')
    if char_class == 'healer':
        return (f'{char_name} нанёс противнику {5 + randint(-3, -1)} ед.урона')
    return (f'{char_name} не нанес урона противнику')


def defence(char_name: str, char_class: str) -> str:
    """Генерирует значение защиты в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Генерирует значение спец.умения в зависимости от класса."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит сообщение о классе персонажа.
    Предлагает начать использовать навыки.
    """
    if char_class == 'warrior':
